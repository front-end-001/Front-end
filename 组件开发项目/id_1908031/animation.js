...
class DOMElementStyleAnimation {
	...
	tick(time) {
		...
		this._element.style[this._property] = this._converter(ease((time - this._startTime) / (this._endTime - this._startTime)) * (this._endValue - this._startValue) + this._startValue);
	}
}
