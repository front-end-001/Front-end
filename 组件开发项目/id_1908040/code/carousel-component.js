...
} from './animation-component.js';
import {
  enableGesture
} from './gesture-component.js';
...
class Carousel {
  ...
  created(config) {
    ...
    this[PROPERTY_SYMBOL].root.style.width = `${config.width}px`;
    this[PROPERTY_SYMBOL].root.style.height = `${config.height}px`;
    this[PROPERTY_SYMBOL].root.style.whiteSpace = `nowrap`;
    this[PROPERTY_SYMBOL].root.style.overflow = 'hidden';
    this[PROPERTY_SYMBOL].root.style.outline = '1px solid blue';
