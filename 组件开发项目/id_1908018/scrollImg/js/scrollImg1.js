                     ...
                     bigImgScroll:function () {
                        ...
                        this.$btnPrev.on(this.opt.btnEvent, function () {
                                ...
                                if (_this.bool) {
                                        ...
                                        //让对应的按钮显示背景色
                                        _this.$sliderNavItem.eq(_this.num).addClass('active').siblings().removeClass('active');
                        ...
                        this.$sliderNavItem.on('click', function () {
                                ...
                                //让对应的按钮显示背景色
                                _this.$sliderNavItem.eq($index).addClass('active').siblings().removeClass('active');
