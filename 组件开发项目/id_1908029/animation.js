...
class DOMElementStyleNumberAnimation {
    ...
    tick(time) {
        ...
        this._element.style[this._property] = this._converter(easeIn((time - this._startTime) / (this._endTime -
            this._startTime)) * (this._endValue - this._startValue) + this._startValue)
    }
}
...
class DOMElementStyleVectorAnimation {
    ...
    tick(time) {
        ...
        let prograss = (time - this._startTime) / (this._endTime - this._startTime)
