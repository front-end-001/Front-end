...
export default class Carousel extends Component {
  ...
  render() {
    ...
    const carousel = <div class="carousel-container">
      <div class="carousel-wrapper">
        { data.map((item => (<div class="carousel-slide">
          <img class="slide-img" src={item.src} title={item.title} style="object-fit: contain;"/>
        </div>))) }
      </div>
      <div class="carousel-pagination"></div>
      { props.enableTouch ? '' : <div class="carousel-button-prev"></div> }
      { props.enableTouch ? '' : <div class="carousel-button-next"></div> }
    </div>;
  ...
  enableGesture() {
    ...
    // this.$el.addEventListener('pan', (event) => {
