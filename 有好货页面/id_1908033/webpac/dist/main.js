...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _js_Tab_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./js/Tab.js */ \"./js/Tab.js\");\n/* harmony import */ var _js_Div_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./js/Div.js */ \"./js/Div.js\");\n// import Carousel from './js/Carousel.js'\n\n\n\nfunction myCreate(Class, attributes) {\n  var object = new Class();\n\n  for (var name in attributes) {\n    object.setAttribute(name, attributes[name]); // 设置 attribute\n    // object[name] = attributes[name];// 设置property\n  }\n\n  for (var _len = arguments.length, children = new Array(_len > 2 ? _len - 2 : 0), _key = 2; _key < _len; _key++) {\n    children[_key - 2] = arguments[_key];\n  }\n\n  for (var _i = 0, _children = children; _i < _children.length; _i++) {\n    var child = _children[_i];\n    object.appendChild(child);\n  } // console.log(children)  打印子对象 for in 遍历对象的属性（普通对象） for of 遍历数组的孩子 （集合型的对象）\n\n\n  return object;\n}\n\nvar c = myCreate(_js_Tab_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"], {\n  style: \"width:100%;height:500px\"\n}, myCreate(_js_Div_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"], {\n  \"tab-title\": \"推荐\",\n  style: \"background-color:red\"\n}), myCreate(_js_Div_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"], {\n  \"tab-title\": \"有趣的店\",\n  style: \"background-color:green\"\n}), myCreate(_js_Div_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"], {\n  \"tab-title\": \"品牌新店\",\n  style: \"background-color:yellow\"\n}));\nc.appendTo(document.body);\n\n//# sourceURL=webpack:///./index.js?");
