/*
 * @Author: your name
 * @Date: 2019-10-27 17:22:05
 * @LastEditTime: 2019-10-27 17:22:06
 * @LastEditors: your name
 * @Description: In User Settings Edit
 * @FilePath: /Front-end/有好货页面/id_1908028/ListView.js
 */
  ...
  render() {
    ...
    return (
      <div>
        ...
        {data.map(item => (
          <div>
            <span style={css.x}>{item.a}</span>
            <span style={css.x}>{item.b}</span>
          </div>
        ))}
      </div>
    );
